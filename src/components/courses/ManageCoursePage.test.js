...
// this ManageCoursePage changed to named component to export that would be easier to test pure function, instead nested inside connect function in redux, otherwise have to use the Provider to import
